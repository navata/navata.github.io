export const myInfo = {
    info: {
        name: "Thai Van Nguyen",
        major: "Mobile & Web Developer",
        email: "thaivanguyen.it@gmail.com",
        phone: "+84 798-366-361",
    ...
    education: {
        ...
        major: "Faculty Of Computer Engineering",
        time: "2010 - 2015",
    },
    certifications: [
        `Participate in the course "Programming on Mobile Devices" by the Nhat Nghe organization`,
        `Certificate in Applied Informatics excellent by Ho Chi Minh City University Of Technology Computer Center.`,
    ],
    skills: [
        `Good communication and presentation skills`,
        `Able to work independently and within a team under pressure`,
        `Hard working, well-organized and with a high sense of responsibility`,
        'Problem solving and analytical skills'
    ],
    hobbies: [
        `Passion for technology and software engineering`,
        `Reading books and listening to music`,
        `Football including commenting and playing`,
    ...
    experiences: [
        {
            title: `Internship at Information Technology Park,
        ...
        {
            title: `Work at DIGI-TEXX company`,
            dateTime: "01/2015 - 12/2015",
            projects: [
                {
        ...
        {
            title: `Work at Global Cybersoft company. `,
            dateTime: "12/2015 - 04/2017",
            projects: [
                {
                ...
                {
                    name: "Website BaiBaiKanri about Estate Agents.",
                    languages:
                        "PHP (Framework CakePHP), HTML, CSS, JavaScript (JQuery).",
                    time: "4 months",
        ...
        {
            title: `Work at Hanbiro Viet Nam company.`,
            dateTime: "04/2017 - Present",
            projects: [
                {
